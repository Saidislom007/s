...
<<<<<<< HEAD
    ...
    const timerRef = useRef<ReturnType<typeof setTimeout> | null>(null); // ✅ To‘g‘rilangan
...
>>>>>>> 3c579e5e5ee7f5b82479ebc8816ca7b6b1779ef0
    ...
    const newRecording = () => deleteRecording();
                    ...
                    <div className="p-8">
                        ...
                        <div className="text-center mb-8">
                            <div className="inline-flex items-center gap-3 bg-slate-900/50 backdrop-blur-sm px-8 py-4 rounded-2xl border border-white/10">
                                {isRecording && (
                                    <div
                                        className={`w-3 h-3 rounded-full ${isPaused ? 'bg-yellow-400' : 'bg-red-500 animate-pulse'
                                            }`}
                                    />
                                )}
